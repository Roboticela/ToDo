...
export function getWelcomeEmail({ userName, appUrl, unsubscribeUrl }) {
  ...
  const bodyHtml = `
    ...
    <p style="margin: 0 0 24px 0; font-size: 16px; line-height: 1.6; color: #334155;">Welcome to ToDo! You're all set to organize your tasks and get more done.</p>
  ...
  let text = `Hi ${userName},\n\nWelcome to ToDo. You can start organizing your tasks right away.\n\nOpen the app: ${appUrl}\n\nBest,\nToDo`;
