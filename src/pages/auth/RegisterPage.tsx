    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4 safe-area-top">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-foreground/60 mt-1">Start organizing your tasks</p>
        </div>

        <div className="bg-card border border-border rounded-2xl p-6 shadow-sm">
          {pendingDesktopAuth ? (
            <DesktopDeviceCodePanel
              userCode={pendingDesktopAuth.userCode}
              onCancel={() => setPendingDesktopAuth(null)}
            />
          ) : (
            <>
              {error && (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="••••••••"
                      className="w-full h-11 pl-10 pr-10 rounded-xl border border-border bg-accent/30 text-foreground placeholder:text-foreground/30 focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary/60 transition-all text-sm"
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className={cn(
                    "w-full h-11 rounded-xl bg-primary text-primary-foreground font-semibold text-sm transition-all mt-2",
